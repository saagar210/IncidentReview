...
- Phase 5 DS1 is in progress: evidence sources + deterministic chunking + local store + thin Tauri commands + minimal UI section (no embeddings/retrieval/drafting yet).
